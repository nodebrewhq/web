    ...
    <div className="container mx-auto px-4 py-16 md:py-24 space-y-24">
      ...
      <section className="text-center max-w-3xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-headline font-bold tracking-tight text-foreground mb-6">
          Start a Nodebrew <span className="text-primary">Chapter</span>
        </h1>
        ...
        <div className="mt-8">
          <Button asChild size="lg">
            <Link
              href="https://forms.gle/your-chapter-form"
              target="_blank"
      ...
      <section>
        <h2 className="text-3xl font-bold text-foreground mb-12 text-center">
          Why Start a <span className="text-primary">Chapter?</span>
        </h2>
        <div className="flex flex-col md:flex-row justify-center gap-8 max-w-5xl mx-auto">
          {whys.map((why, i) => (
            <div
              key={i}
              className="bg-muted p-8 rounded-lg shadow-md flex-1 cursor-pointer transform transition-transform duration-300 hover:scale-105"
            >
